...
RUN apt-get update && apt-get install && apt-get upgrade -y libc6-dev
...
RUN R -e "install.packages(c('devtools', 'shiny', 'rmarkdown', 'tm', 'wordcloud', 'memoise', 'dplyr', 'tidyr', 'scales', 'plotly', 'readxl', 'readr', 'car', 'shinydashboard', && \
		'rgdal', 'raster', 'tidycensus', 'tmap', 'tmaptools', 'stringr', 'tidyverse', 'knitr', 'kableExtra', 'RPostgeSQL', 'shinyjs', 'VennDiagram', 'geojsonio', && \
		'gridExtra', 'ggthemes', 'maptools', 'officer', 'flextable', 'tinytex', 'curl'))" && \
